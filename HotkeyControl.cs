    ...
    public class HotkeyControl : TextBox
    {
        ...
        private void Redraw(bool bCalledProgramatically)
        {
            ...
            if (bCalledProgramatically == false)
            {
                ...
                {
                    // Commented out because this was extraneously suggesting modifiers, 
                    // disallowing the single key from being used as a valid hotkey if it was present in needNonShiftModifier.
                    /*
